...
export const summaryMaterials: SummaryMaterial[] = [
  ...
  { id: 'disc_fuvest_bio_2025_cerrado', subject: 'Biologia', topic: 'Biomas brasileiros', format: 'questao-discursiva', sourceFile: 'src/data/discursiveQuestions.ts', board: 'Fuvest', phase: 'segunda', uncertain: true },
  { id: 'disc_fuvest_bio_2026_parkinson', subject: 'Biologia', topic: 'Fisiologia do sistema nervoso', format: 'questao-discursiva', sourceFile: 'src/data/discursiveQuestions.ts', board: 'Fuvest', phase: 'segunda', uncertain: true },
  ...
  { id: 'disc_fuvest_bio_2026_hidrocarbonetos', subject: 'Biologia', topic: 'Estrutura e Fisiologia Celular', format: 'questao-discursiva', sourceFile: 'src/data/discursiveQuestions.ts', board: 'Fuvest', phase: 'segunda', uncertain: true },
  { id: 'disc_fuvest_fis_2026_homem_aranha', subject: 'Física', topic: 'Dinâmica Energética e Transformações de Energia', format: 'questao-discursiva', sourceFile: 'src/data/discursiveQuestions.ts', board: 'Fuvest', phase: 'segunda', uncertain: true },
  { id: 'disc_fuvest_fis_2026_pipoca', subject: 'Física', topic: 'Cinemática Escalar', format: 'questao-discursiva', sourceFile: 'src/data/discursiveQuestions.ts', board: 'Fuvest', phase: 'segunda', uncertain: true },
  { id: 'disc_fuvest_geo_2026_amazonia_legal', subject: 'Geografia', topic: 'Geopolítica Regional Contemporânea', format: 'questao-discursiva', sourceFile: 'src/data/discursiveQuestions.ts', board: 'Fuvest', phase: 'segunda', uncertain: true },
  { id: 'disc_fuvest_his_2026_universidades_medievais', subject: 'História', topic: 'Idade Média', format: 'questao-discursiva', sourceFile: 'src/data/discursiveQuestions.ts', board: 'Fuvest', phase: 'segunda', uncertain: true },
  { id: 'disc_fuvest_qui_2026_aluminio_combustivel', subject: 'Química', topic: 'Eletroquímica', format: 'questao-discursiva', sourceFile: 'src/data/discursiveQuestions.ts', board: 'Fuvest', phase: 'segunda', uncertain: true },
