...
export interface RetrievalPrompt { id: string; sectionId?: string; prompt: string; expectedElements: RetrievalElement[]; hint: string; transferPrompt: string; }
...
export interface RetrievalAttempt {
  ...
  subject?: string; topic?: string; boards?: string[]; materialIds?: string[];
}
