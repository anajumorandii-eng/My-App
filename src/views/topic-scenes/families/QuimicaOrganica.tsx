...
function IsomerDiagram({ label }: { label: string }) {
  if (label === 'Plana') return <svg viewBox="0 0 220 100" role="img" aria-label="Butano linear e isobutano ramificado com a mesma fórmula" data-structure="constitutional-isomers"><polyline points="18,36 55,18 92,36 129,18" className="tc-organic-skeleton"/><polyline points="18,78 58,58 98,78 138,58" className="tc-organic-skeleton"/><line x1="58" y1="58" x2="58" y2="91" className="tc-organic-bond"/><text x="154" y="34" className="tc-organic-mini-label">linear</text><text x="154" y="78" className="tc-organic-mini-label">ramificada</text><text x="154" y="95" className="tc-organic-formula-note">C₄H₁₀</text></svg>;
  if (label === 'Geométrica') return <svg viewBox="0 0 220 100" role="img" aria-label="Isômeros cis e trans ao redor de ligação dupla" data-structure="cis-trans"><Bond x1={46} y1={50} x2={87} y2={50} order={2}/><Bond x1={133} y1={50} x2={174} y2={50} order={2}/><text x="66" y="18" className="tc-organic-atom">CH₃  CH₃</text><text x="66" y="91" className="tc-organic-mini-label">cis</text><text x="153" y="18" className="tc-organic-atom">CH₃</text><text x="153" y="84" className="tc-organic-atom">CH₃</text><text x="153" y="99" className="tc-organic-mini-label">trans</text></svg>;
