...
const qaNotes = 'QA técnico: 360, 375, 390, 768 e 1440 px; temas claro/escuro; primeira e última seleção; teclado; movimento reduzido; axe sem violações. Revisão editorial frente às referências aprovadas ainda pendente.';
