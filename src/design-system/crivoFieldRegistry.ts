...
export const FIELD_REGISTRY: Record<FieldType, FieldGradient> = {
  ...
  layer: (palette) => `radial-gradient(ellipse at 50% 30%, ${palette.primary}22 0%, transparent 40%), linear-gradient(180deg, ${palette.atmoA}, ${palette.atmoB})`,
  argument: (palette) => `linear-gradient(90deg, ${palette.primary}18 0 2px, transparent 2px), linear-gradient(145deg, ${palette.atmoA}, ${palette.atmoB})`,
  pulse: (palette) => `radial-gradient(circle at 50% 50%, ${palette.primary}26 0%, transparent 45%), linear-gradient(135deg, ${palette.atmoA}, ${palette.atmoB})`,
