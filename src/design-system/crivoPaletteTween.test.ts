...
const dark: CrivoPalette = { bg:'#000000', surface:'#000000', primary:'#000000', secondary:'#000000', emissive:'#000000', textHighlight:'#000000', textAccent:'#000000', focusAccent:'#000000', dataPositive:'#000000', dataWarning:'#000000', atmoA:'#000000', atmoB:'#000000' };
const light: CrivoPalette = { bg:'#FFFFFF', surface:'#FFFFFF', primary:'#FFFFFF', secondary:'#FFFFFF', emissive:'#FFFFFF', textHighlight:'#FFFFFF', textAccent:'#FFFFFF', focusAccent:'#FFFFFF', dataPositive:'#FFFFFF', dataWarning:'#FFFFFF', atmoA:'#FFFFFF', atmoB:'#FFFFFF' };
...
test('crivo palette: interpola uma cor e todos os dez tokens em cada frame', () => {
  ...
  assert.equal(Object.keys(tweenPalette(dark, light, 0.5)).length, 12);
});
