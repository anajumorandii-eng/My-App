...
- [x] As 26 pranchas autorais encontradas na `main` foram preservadas e Newton
  elevou o registro para 27.
- [x] Leis de Newton ganhou uma prancha radial específica.
- [x] Arrastar e soltar no modo Reconstruir, preservando clique e teclado.
- [x] Capturas finais de Física, Biologia, Química, tema escuro e mobile.
